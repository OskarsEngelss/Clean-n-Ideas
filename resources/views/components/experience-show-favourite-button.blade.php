<div class="experience-show-favourite-button-container">
    <button id="experience-show-favourite-button" data-auth-check="{{ Auth::check() }}" data-list-id="{{ $favouritesListId }}" data-tutorial-id="{{ $experienceId }}" class="{{ $favourited ? 'favourited-check' : '' }}">
        @if($favourited)
