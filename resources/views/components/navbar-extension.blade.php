<div id="navbar-extension" class="hidden-right">
    <a href="{{ route('profile.show', auth()->user()->id) }}" class="side-pannel-nav-link">
    ...
    <a href="{{ route('profile.settings') }}" class="side-pannel-nav-link">
        <svg xmlns="http://www.w3.org/2000/svg" height="35px" viewBox="0 -960 960 960" width="35px" fill="var(--text-color)">
    ...
    <form method="POST" action="/logout" class="logout-button-form">
        @csrf
        <button class="logout-button side-pannel-nav-link">
            <svg xmlns="http://www.w3.org/2000/svg" height="35px" viewBox="0 -960 960 960" width="35px" fill="var(--text-color)">
